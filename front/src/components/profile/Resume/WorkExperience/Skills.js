    ...
    return (
        <Wrap>
                ...
                <Content>
                    ...
                    <LogoWrap>
                    <SkillsLogo src={htmlLogo} alt="htmlLogo" width="50px" height="50px"></SkillsLogo>
                    <SkillsDesc>{`HTML\nCSS\nJS`}</SkillsDesc>
                    </LogoWrap>
                    <LogoWrap>
                    <SkillsLogo src={reactLogo} alt="reactLogo" width="50px" height="50px"></SkillsLogo>
                    <SkillsDesc>React</SkillsDesc>
                    </LogoWrap>
                    <LogoWrap>
                    <SkillsLogo src={reduxLogo} alt="reduxLogo" width="50px" height="50px"></SkillsLogo>
                    <SkillsDesc>Redux</SkillsDesc>
                    </LogoWrap>
                    <LogoWrap>
                    <SkillsLogo src={typescriptLogo} alt="typescriptLogo" width="50px" height="50px"></SkillsLogo>
                    <SkillsDesc>{`Type\nscript`}</SkillsDesc>
                    </LogoWrap>
                </Content>
                <Content>
                    ...
                    <LogoWrap>
                    <SkillsLogo src={nodeLogo} alt="nodeLogo" width="50px" height="50px"></SkillsLogo>
                    <SkillsDesc>Node</SkillsDesc>
                    </LogoWrap>
                    <LogoWrap>
                    <SkillsLogo src={mongodbLogo} alt="mongodbLogo" width="50px" height="50px"></SkillsLogo>
                    <SkillsDesc>{`Mongo\nDB`}</SkillsDesc>
                    </LogoWrap>
                    <LogoWrap>
                    <SkillsLogo src={mysqlLogo} alt="mysqlLogo" width="50px" height="50px"></SkillsLogo>
                ...
                <Content>
                    ...
                    <LogoWrap>
                    <SkillsLogo src={gitLogo} alt="gitLogo" width="50px" height="50px"></SkillsLogo>
